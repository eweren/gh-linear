...
export const ARGS = parse<Arguments>(
  {
    ...
    find: { type: String, alias: 'f', optional: true, description: 'Search for tickets' },
    ...
    status: { type: Boolean, optional: true, alias: 's', description: 'Shows the status of the current branch/ticket' },
